...
@Repository
public interface PolicyTravelTravellerRepository extends JpaRepository<PolicyTravelTravellerEntity, String> {

    List<PolicyTravelTravellerEntity> findAllByPolicyVersion_Id(String policyVersionId);

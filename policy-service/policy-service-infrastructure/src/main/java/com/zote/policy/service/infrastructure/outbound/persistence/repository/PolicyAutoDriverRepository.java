...
@Repository
public interface PolicyAutoDriverRepository extends JpaRepository<PolicyAutoDriverEntity, String> {

    List<PolicyAutoDriverEntity> findAllByPolicyVersion_Id(String policyVersionId);
